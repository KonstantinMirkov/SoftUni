...
// Initialize entity
        Pet1 dog = new Pet1("Ellias", 5, "Tim");
...
// Remove Pet
        ...
        Pet1 cat = new Pet1("Bella", 2, "Mia");
        Pet1 bunny = new Pet1("Zak", 4, "Jon");

        clinic.add(cat);
        clinic.add(bunny);

// Get Oldest Pet
        Pet1 oldestPet = clinic.getOldestPet();
        System.out.println(oldestPet); // Zak 4 (Jon)

// Get Pet
        Pet1 pet = clinic.getPet("Bella", "Mia");
